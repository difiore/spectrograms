...
d1_dynaSpec <- prep_static_ggspectro(
  f1,
...
d2_dynaSpec <- prep_static_ggspectro(
  f2,
  colPal = c("white", "black"),
  xLim = c(0,20),
  yLim =c(0,3),
...
d3_dynaSpec <- prep_static_ggspectro(
  f3,
  colPal = c("white", "black"),
  xLim = c(0,20),
  yLim =c(0,3),
...
d4_dynaSpec <- prep_static_ggspectro(
  f4,
  colPal = c("white", "black"),
  xLim = c(0,20),
  yLim =c(0,3),
...
d1_bioacoustics <- bioacoustics::spectro(wav1, FFT_size = 512, FFT_overlap = 0.5, FFT_win = "hann")

d2_bioacoustics <- bioacoustics::spectro(wav2, FFT_size = 512, FFT_overlap = 0.5, FFT_win = "hann")

d3_bioacoustics <- bioacoustics::spectro(wav1, FFT_size = 512, FFT_overlap = 0.5, FFT_win = "hann")

d4_bioacoustics <- bioacoustics::spectro(wav1, FFT_size = 512, FFT_overlap = 0.5, FFT_win = "hann")
```
